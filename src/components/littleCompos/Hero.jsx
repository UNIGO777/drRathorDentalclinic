                ...
                <div className="grid relative grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-2 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col lg:w-1/2 sm:flex-col lg:flex-row gap-4 sm:gap-6">
                            <a href="tel:8818887752" className="px-6 sm:px-8 py-3 rounded-full hover:bg-[#00000064] flex items-center justify-center bg-[#5e5eee] text-white transition duration-300 font-semibold w-full">
            ...
            >
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-4">
                    <div className="flex items-center p-2 sm:p-4 gap-3 w-full lg:w-auto">
                        ...
                        <div>
                            <p className="text-gray-800 font-bold text-sm sm:text-base lg:text-lg">Need Help?</p>
                            <p className="text-gray-500 text-xs sm:text-sm">881 888 7752</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center p-2 sm:p-4 gap-3 w-full lg:w-auto">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-xs sm:text-sm">Mon to Sat 9:00 AM to 5:00 PM</p>
                        </div>
                    </div>
