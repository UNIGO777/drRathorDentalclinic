...
const About = ({pt}) => {
    ...
    return (
        <div className="py-8  sm:py-12 md:pb-16 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className={`flex ${!pt && "pt-44"} flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12`}>
                        ...
                        <div className='flex gap-5 items-center '>
                            <Link to="/contact">
                                <motion.button
                                    ...
                                    className="w-full sm:w-auto bg-[#5e5eee] hover:bg-[black] max-h-15 flex items-center justify-center text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 font-bold rounded-full text-sm sm:text-base cursor-pointer transition-colors duration-300"
                                >
                                    Contact us
