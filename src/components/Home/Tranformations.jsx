  ...
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-sm flex gap-2  font-semibold text-[#5e5eee] tracking-wide uppercase"><svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5" viewBox="0 0 50 40" stroke="#5e5eee" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-col  md:flex-row justify-between md:items-center '>
                        ...
                        <motion.button
                            ...
                            className="w-fit md:w-auto mt-4 md:mt-0 bg-[#5e5eee] max-h-15 flex items-center justify-center text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 font-bold rounded-full text-sm sm:text-base hover:bg-[#4b4bdd] transition-colors duration-300"
                        >
                            Contact Now
