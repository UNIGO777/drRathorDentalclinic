            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                >
                    <h2 className="text-sm flex gap-2 font-semibold text-[#5e5eee] tracking-wide uppercase">
                        <svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5" viewBox="0 0 50 40" stroke="#5e5eee" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h3 className="mt-2 text-[3em] leading-13 w-full font-extrabold text-gray-900">
